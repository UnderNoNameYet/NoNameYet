...
- inspected v0.4.0 release merge: `bc5ed44111084cea80dc157a3cfbabacf30eec61`
- release pull request: [#30](https://github.com/UnderNoNameYet/NoNameYet/pull/30)
- release deployment: successful main [workflow run #68](https://github.com/UnderNoNameYet/NoNameYet/actions/runs/33952234143)
- exact commit checks: `https://github.com/UnderNoNameYet/NoNameYet/commit/bc5ed44111084cea80dc157a3cfbabacf30eec61/checks`
- immediate pre-release known-good main: `a1baa9ebde9bf1b1a05d7a0563ee9927ff96f9af`

The live TenantBoundary v0.4.0 request-only preview keeps the Focus Workbench and generated four-page fictional report while expanding the public contract from 27 to 29 files for canonical assets and byte-identical former-path aliases. The release replaced the former TenantProof public name without changing the offer or safety model. `a1baa9ebde9bf1b1a05d7a0563ee9927ff96f9af` is the immediate rollback, while `047691e35c6b8d38ba5540d1fe4de345ed752a6c` remains the older pre-TenantProof recovery reference.
...
PR #30 met those conditions for v0.4.0. It passed exact-head CI, generated PDF/image alias checks, all 88 changed-file review, focused secret/private-email scanning, and public review surfaces before merge.
...
- revert v0.4.0 release merge `bc5ed44111084cea80dc157a3cfbabacf30eec61` or restore known-good main `a1baa9ebde9bf1b1a05d7a0563ee9927ff96f9af`
