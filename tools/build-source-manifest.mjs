...
const manifest = { generatedAt: new Date().toISOString(), product: 'TenantBoundary', version: '0.4.0', sourceOfTruth: 'AGENTS.md and handoff/README.md', deployRoot: 'public/', files: files.length, bytes: files.reduce((sum, file) => sum + file.bytes, 0), byRole: grouped, entries: files };
