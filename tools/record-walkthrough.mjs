...
args.push('-filter_complex', [
  ...
  '[2:v]scale=1440:900:force_original_aspect_ratio=increase,crop=1440:900,setsar=1,fps=24,fade=t=in:st=0:d=0.35,fade=t=out:st=3.65:d=0.35[v2]',
  '[3:v]scale=1440:900:force_original_aspect_ratio=decrease,pad=1440:900:(ow-iw)/2:(oh-ih)/2:color=0x17191c,setsar=1,fps=24,fade=t=in:st=0:d=0.35,fade=t=out:st=3.65:d=0.35[v3]',
  '[4:v]scale=1440:900:force_original_aspect_ratio=decrease,pad=1440:900:(ow-iw)/2:(oh-ih)/2:color=0x17191c,setsar=1,fps=24,fade=t=in:st=0:d=0.35,fade=t=out:st=3.65:d=0.35[v4]',
  '[v0][v1][v2][v3][v4]concat=n=5:v=1:a=0[out]'
].join(';'), '-map', '[out]', '-an', '-c:v', 'libvpx-vp9', '-crf', '34', '-b:v', '0', '-row-mt', '1', '-pix_fmt', 'yuv420p', output);
